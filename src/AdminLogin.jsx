  ...
  return (
    <div className="admin-login-container">
      ...
      <div className="admin-app-info">
        <h1 className="admin-app-title">SalesSavvy Admin</h1>
        <p className="admin-app-description">Manage your sales efficiently.</p>
      </div>
      ...
      <div className="form-container">
        ...
        <div className="form-footer">
          <a href="/" className="form-link">Not an Admin? Login as User</a>
        </div>
      </div>
    </div>
  );
